...
!function(t, e) {
    ...
    function n(t) {
        for (var e = 0, o = t.container, n = t.rows, r = n.length - 1; r >= 0; r--)
            e = n[r] > e ? n[r] : e;
        o.style.height = e + "px"
    }
    function r(e, o) {
    ...
    var a = function t(e, o) {
        if (!(this instanceof t))
            return new t(e, o);
        if (e = e.replace(/^\s*/, "").replace(/\s*$/, ""), o)
            return this.byCss(e, o);
        for (var n in this.selectors)
            if (o = n.split("/"), new RegExp(o[1], o[2]).test(e))
    ...
    var c = function(t, e) {
        ...
        v = function t() {
            ...
            if (!(this instanceof t))
                return new t(e);
            if (this.options = {}, d(this.options, m, e), this.container = a(e.container), this.container instanceof a || !this.container)
            ...
            if (this.resizer = s(function() {
                n()
            }, 100), window.addEventListener("resize", this.resizer), e.waitForImages)
                return h(r, null, n);
